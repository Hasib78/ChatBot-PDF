...
# Updated import for memory efficiency
...
# Shared embedding function to save memory and ensure consistency
...
async def upload_pdfs(files: List[UploadFile] = File(...)):
    try:
        ...
        # This function in your modules already handles saving and vectorizing
...
async def ask_question(question: str = Form(...)):
    try:
        ...
        # Use the API-based embedding function instead of local model
        vectorstore = Chroma(
...
async def clear_database():
    try:
        ...
        try:
            # Use the API-based embedding function here too
...
# from langchain_community.embeddings import HuggingFaceEmbeddings -deploy edit
